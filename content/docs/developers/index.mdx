...
Readers can use an AI agent to explore your collections, ask about a work, and follow its sources.
Canopy provides this access through WebMCP, which is enabled by default and works with your static
site. [IIIF and AI Tools](/docs/developers/iiif-and-ai-tools) explains how to make the tools available,
try them with your collection, and use the source and citation links in a response.
